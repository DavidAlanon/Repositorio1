...
(  \     ) \ (  ,   (   (  ,  ) \    \ (         (  ,   (   (  ,' ) \  `.) /  )  (  ``-.  
    ...
    def __fight(self):
        ...
        if  player2.power <= 0: #ha perdido una vida
            ...
            if player2.lives > 0:
                ...
                if len(current_players) == 2:
                    print(Fore.LIGHTGREEN_EX + '{} HA GANADO EL JUEGO'.format(player1))
                    return

            player1.gems +=1
            print (Fore.GREEN + '{} ha ganado una gema (tiene {})'.format(player1, player1.gems)+ Fore.WHITE)
            ...
            # comprobar si alguien ha ganado el juego, o lo que se lo mismo
    ...
    def __add_player(self):
        ...
        gender = ''
        while len(gender) < 4:
            gender = input('\nIntroduce tu género (male/female): ') 
